...
import brIcon from '/imgs/brazil.png'

function header() {
  return (
    <header className="glassMorph grid grid-cols-3 items-center w-4/5 h-[8dvh] animate-enter overflow-hidden lg:h-[9dvh] ">
      <div className="shineclass"/>
      <img src={brIcon} alt="Bandeira do Brasil" className="pl-5 w-15 sm:w-13 md:w-16 lg:w-18 xl:w-20" />
